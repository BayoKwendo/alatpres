...
public class IDListAdapter extends BaseAdapter implements Filterable, ISpinnerSelectedView {
    ...
    public IDListAdapter(Context context, ArrayList<String> strings) {
        mContext = context;
        mID = strings;
    ...
    @Override
    public int getCount() {
        return mID == null ? 0 : mID.size() + 1;
    }

    @Override
    public Object getItem(int position) {
        if (mID != null && position > 0)
            return mID.get(position - 1);
        else
            return null;
    }
    ...
    public long getItemId(int position) {
        if (mID == null && position > 0)
            return mID.get(position).hashCode();
        else
            return -1;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == 0) {
            ...
            letters.setImageDrawable(getTextDrawable(mID.get(position-1)));
            dispalyName.setText(mID.get(position-1));
        }
        return view;
    }

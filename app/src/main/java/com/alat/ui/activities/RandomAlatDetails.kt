...
class RandomAlatDetails : AppCompatActivity() {
...
//        Toast.makeText(this@AlertDetails, "Success"  + , Toast.LENGTH_LONG).show()
    ...
    private fun getStudent() {
        ...
        val api: GetRandomOneAlat = retrofit.create(
            GetRandomOneAlat::class.java
        )
...
//                mname!!.visibility=View.VISIBLE
    ...
    fun updates() {
        ...
        updateButton.setOnClickListener(View.OnClickListener {
            ...
            if (spinner3!!.selectedItem == null) {
                Toast.makeText(this@RandomAlatDetails, "Please select an RG", Toast.LENGTH_LONG).show();

...
class AlertsGlobal : AppCompatActivity(), AlertAdapter.ContactsAdapterListener  {

   var response_group: String? = null
    var group_id: String? = null

    private val TAG = AlertsGlobal::class.java.simpleName
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        global!!.setOnClickListener {
            startActivity(Intent(this@AlertsGlobal, CreateGlobalAlert::class.java))
        }
   ...
   fun BackAlert() {
       AlertDialog.Builder(this)
           ...
           .setPositiveButton("Yes") { _, id ->
               startActivity(Intent(this@AlertsGlobal, HomePage::class.java))
           }

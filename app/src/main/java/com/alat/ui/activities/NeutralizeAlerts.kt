...
class NeutralizeAlerts : AppCompatActivity(), AlertAdapter.ContactsAdapterListener {

    var response_group: String? = null

    private val TAG = NeutralizeAlerts::class.java.simpleName
    ...
    private fun getStudent() {
        ...
        mToolbar!!.title = "Neutralized Alerts"
        ...
        val api: GetNeutralizeAlerts = retrofit.create(GetNeutralizeAlerts::class.java)
        val call: Call<ResponseBody> = api.GetNeutralized(params)

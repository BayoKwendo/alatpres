...
import com.alat.R
import com.alat.adapters.InvitationAdapter
...
class Invitations : AppCompatActivity(), InvitationAdapter.ContactsAdapterListener {

    var response_group: String? = null

    private val TAG = Invitations::class.java.simpleName
    private var recyclerView: RecyclerView? = null
    private var contactList: MutableList<rgModel>? = null
    private var mAdapter: InvitationAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mAdapter = InvitationAdapter(this, contactList!!, this)
    ...
    private fun dialogue() {
        ...
        AlertDialog.Builder(this)
            .setPositiveButton("Exit") { _: DialogInterface?, _: Int ->
                //recreate()
                val i = Intent(this, Invitations::class.java)

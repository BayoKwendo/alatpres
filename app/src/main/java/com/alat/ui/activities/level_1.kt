...
class level_1 : AppCompatActivity(), CustomeAdapter.ContactsAdapterListener  {

   var response_group: String? = null

    private val TAG = level_1::class.java.simpleName
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mToolbar!!.title = "Level 2 Configurations"
   ...
   fun BackAlert() {
       AlertDialog.Builder(this)
           ...
           .setPositiveButton("Yes") { _, id ->
               startActivity(Intent(this@level_1, HomePage::class.java))
           }
...
//        ).show()
    ...
    private fun config() {
        ...
        val api: CONFIGlv1 = retrofit.create(CONFIGlv1::class.java)
    ...
    private fun deleteConfig() {
        ...
        val api: deleteConfig2 = retrofit.create(deleteConfig2::class.java)
        val call: Call<ResponseBody> = api.config(params)
    ...
    private fun dialogue() {
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton(
                ...
                val i = Intent(this, level_1::class.java)
                i.putExtra("rg_id", rg_id)

...
import com.alat.interfaces.GetRandomAlat
...
class RandomAlats : AppCompatActivity(), AlertAdapter.ContactsAdapterListener  {
    ...
    private fun getRandomAlats() {
        ...
        val api: GetRandomAlat = retrofit.create(GetRandomAlat::class.java)
    ...
    fun BackAlert() {
       AlertDialog.Builder(this)
           ...
           .setPositiveButton("Yes") { _, id ->
             startActivity(Intent(this@RandomAlats, HomePage::class.java))
           }
...
//        ).show()
        ...
        val i =
            Intent(this, RandomAlatDetails::class.java)

...
class ResponseAdapter(
    ...
    inner class MyViewHolder(view: View) :
        ...
        init {
            ...
            person = view.findViewById(R.id.tv_topic_starter)
            time = view.findViewById(R.id.tv_date_created)
    ...
    override fun onBindViewHolder(
        ...
        holder.name.text = contact.content
        holder.person.text = "By: "+contact.fullname
//        //val cal: Calendar = GregorianCalendar(contact.content)
//        date = DateUtils.formatDateTime(
//            context,
//            cal.getTimeInMillis(),
//            DateUtils.FORMAT_SHOW_DATE or DateUtils.FORMAT_NUMERIC_DATE or DateUtils.FORMAT_SHOW_TIME
//        )
        holder.time.text = "Date: "+contact.date_posted
    }

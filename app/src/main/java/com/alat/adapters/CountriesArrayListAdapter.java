...
public class CountriesArrayListAdapter extends ArrayAdapter<String> implements Filterable, ISpinnerSelectedView {
    ...
    public CountriesArrayListAdapter(Context context, ArrayList<String> strings) {
    ...
    @Override
    public int getCount() {
        return mCountries == null ? 0 : mCountries.size() + 1;
    }

    @Override
    public String getItem(int position) {
        if (mCountries != null && position > 0)
            return mCountries.get(position - 1);
        else
            return null;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == 0) {
            ...
            letters.setImageDrawable(getTextDrawable(mCountries.get(position-1)));
            dispalyName.setText(mCountries.get(position-1));
        }
        return view;
    }
    ...
    public class StringFilter extends Filter {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            mCountries = (ArrayList) results.values;

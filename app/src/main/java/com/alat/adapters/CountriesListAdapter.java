...
public class CountriesListAdapter extends BaseAdapter implements Filterable, ISpinnerSelectedView {
    ...
    public CountriesListAdapter(Context context, ArrayList<String> strings) {
        mContext = context;
        mCountries = strings;
